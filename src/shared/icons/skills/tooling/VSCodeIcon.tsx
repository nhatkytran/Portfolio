...
/** VSCode icon. */
export default function VSCodeIcon({ className }: PropsWithClassName) {
  return (
    <svg height={24} width={24} className={className} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
