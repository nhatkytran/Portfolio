...
/** D3 icon. */
export default function D3Icon({ className }: PropsWithClassName) {
  return (
    <svg width={24} height={24} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
      <linearGradient
        id="d3js-original-a"
